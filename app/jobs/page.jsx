...
export default function JobsPage() {
  ...
  const sampleJobs = [
    ...
    },
    {
      ...
      company_name: "CloudEdge Pvt Ltd",
      location: "Remote",
      job_type: "Full Time",
      work_mode: "Remote",
      min_salary: 800000,
  ...
  useEffect(() => {
    ...
    if (workModeFilter) {
      result = result.filter(
        (job) => job.work_mode?.toLowerCase() === workModeFilter.toLowerCase(),
      );
    }
  ...
  const workModes = [
    ...new Set(jobs.map((job) => job.work_mode).filter(Boolean)),
  ].sort();
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <div className="relative filter-dropdown">
                  ...
                  >
                    ...
                    <ChevronRight
                      className={`w-4 h-4 transition-transform ${showJobTypeDropdown ? "rotate-90" : ""}`}
                    />
                  </button>
                ...
                <div className="relative filter-dropdown">
                  ...
                  >
                    ...
                    <ChevronRight
                      className={`w-4 h-4 transition-transform ${showWorkModeDropdown ? "rotate-90" : ""}`}
                    />
                  </button>
